...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String SQL_CREATE_ENTRIES = "CREATE TABLE " + TABLE_TODO_ITEMS + "("
                ...
                + ITEM_CHECKED_DATE + " TEXT," + ITEM_DESCRIPTION + " TEXT" + ")";
    ...
    public TodoItem getTodoItem(int id) {
        ...
        Cursor cursor = db.query(TABLE_TODO_ITEMS, new String[]{ITEM_ID,
                        ITEM_TITLE, ITEM_DATE, ITEM_CHECKED, ITEM_CHECKED_DATE, ITEM_DESCRIPTION}, ITEM_ID + "=?",
        ...
        return new TodoItem(Integer.parseInt(cursor.getString(0)), cursor.getString(1), date, Boolean.valueOf(cursor.getString(3)), checkedDate, cursor.getString(5));
    }
